...
class GhanaDemandPredictor:
    ...
    def load_data(self):
        ...
        print("Loading transport data for demand prediction from database...")
        if self.city:
    ...
    def prepare_demand_features(self):
        ...
        stop_times = self.data['stop_times'].copy() if 'stop_times' in self.data else pd.DataFrame()
        ...
        if stop_times.empty or stops.empty or trips.empty or routes.empty:
            print("❌ Not enough data to prepare demand features.")
